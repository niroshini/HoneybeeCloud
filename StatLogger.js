...
class StatLogger {
  ...
  static JOB_RECEIVED_TIME = "jobReceivedTime";
  ...
  static logHeader() {
    return `${this.JOB_ID},${this.STEAL_REQUEST_TIME},${this.JOB_RECEIVED_TIME},${this.JOB_TRANSMISSION_TIME},${this.UNZIP_START_TIME},${this.UNZIP_END_TIME},${this.JOB_START_TIME},${this.JOB_END_TIME},${this.COMPUTATION_TIME},${this.RESULT_SENT_TIME}`;
  }

  saveLogToFile() {
    var log = StatLogger.logHeader();
    for (var key in this.jobLogs) {
      log += `\n${key},${this.jobLogs[key][StatLogger.STEAL_REQUEST_TIME]},${this.jobLogs[key][StatLogger.JOB_RECEIVED_TIME]},${this.jobLogs[key][StatLogger.JOB_TRANSMISSION_TIME]},${this.jobLogs[key][StatLogger.UNZIP_START_TIME]},${this.jobLogs[key][StatLogger.UNZIP_END_TIME]},${this.jobLogs[key][StatLogger.JOB_START_TIME]},${this.jobLogs[key][StatLogger.JOB_END_TIME]},${this.jobLogs[key][StatLogger.COMPUTATION_TIME]},${this.jobLogs[key][StatLogger.RESULT_SENT_TIME]}`;
    }
